...
public class QueryDSLTest {
	...
	@Test
	@DisplayName("projectoins 테스트")
	public void testProjectoins() {
	...
	@Test
	@DisplayName("thetajoin 테스트") //프로젝트할 때 쓰지마라
	...
	@DisplayName("groupBy")
	public void groupBy() {
		//카테코리별 도서들의 최대 재고, 평균 재고, 평균 대출 횟수
...
//		});
	...
	public void dynamicQueryWithBook() {
		...
		//bookDto의 bookAtm보다 도서재고가 많거나 같은면서
		//bookDto의 rentCnt보다 대출횟수가 적거나 같은 도서를 조회
		//만약 bookDto의 bookAmt나 rentCnt에 null이 담겨있다면 쿼리에서 제외
		...
		public void entityGraph() {
			rentRepository.findByTitleStartsWithOrMemberUserIdEquals("디디", "jpa");
